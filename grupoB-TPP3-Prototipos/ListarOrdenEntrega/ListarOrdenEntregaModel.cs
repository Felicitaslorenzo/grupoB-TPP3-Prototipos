...
namespace grupoB_TPP3_Prototipos.ListarOrdenEntrega
{
    internal class ListarOrdenEntregaModel
    {
        ...
        OrdenEntregaAlmacen.OrdenesEntrega.Select(oe => new OrdenEntrega
       {
             ...
             FechaEmision = oe.FechaEntrega,
             FechaEstado = oe.FechaEstado,
             Estado = oe.Estado, // No estan en la entidad

            // Obtiene las órdenes de preparación asociadas para cada orden de entrega.
             OrdenesPreparacion = OrdenPreparacionAlmacen.OrdenesPreparacion
            .Where(op => op.IdOrdenPreparacion == oe.IdOrdenEntrega) // Como asocio?, en el form esta por IDCLIENTE 
